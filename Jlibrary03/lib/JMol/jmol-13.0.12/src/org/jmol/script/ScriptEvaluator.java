/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2012-11-10 10:56:32 +0100 (sam., 10 nov. 2012) $
 * $Revision: 17710 $
 *
  ...
  private Object evaluate(Object expr, boolean asVariable) {
    try {
      if (expr instanceof String) {
        ...
        return (asVariable ? ScriptVariable.getVariable(bs): bs);
...
//    }
  ...
  private Point3f getObjectCenter(String axisID, int index, int modelIndex) {
    ...
    return (getShapeProperty(JmolConstants.SHAPE_DRAW, "getCenter", data)
        ...
        || getShapeProperty(JmolConstants.SHAPE_PMESH, "getCenter", data)
  ...
  private Point3f[] getObjectBoundingBox(String id) {
    ...
    return (getShapeProperty(JmolConstants.SHAPE_ISOSURFACE, "getBoundingBox",
        data)
        || getShapeProperty(JmolConstants.SHAPE_PMESH, "getBoundingBox", data)
