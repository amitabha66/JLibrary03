/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2012-12-01 20:24:59 +0100 (sam., 01 déc. 2012) $
 * $Revision: 17783 $
 *
...
public class Viewer extends JmolViewer implements AtomDataServer {
  ...
  private Viewer(Object display, JmolAdapter modelAdapter,
    ...
    haveDisplay = (display != null && !isHeadless() && commandOptions
        .indexOf("-n") < 0 && !commandOptions.startsWith("JmolData"));
    ...
    if (!isError && model instanceof String) {
      ...
      if (data.length() != 0) {
        ...
        model = getModelAdapter().getAtomSetCollectionReader("ligand", null,
            ZipUtil.getBufferedReaderForString(data), htParams);
